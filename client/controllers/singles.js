(function () {
    'use strict';
    angular.module('elbeat.app').service('SinglesService', function ($http) {
        var obj = {};
        obj.getSingles = function () {
            return $http.get(serviceBase + 'singles');
        }
        return obj;
    }).controller('SinglesController', ['$scope', 'SinglesService', 'PlayerService',
        function ($scope, SinglesService, PlayerService) {
